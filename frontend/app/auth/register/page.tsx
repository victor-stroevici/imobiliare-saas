    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-50 py-12">
      <div className="bg-white rounded-2xl shadow-sm border p-8 w-full max-w-md">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition disabled:opacity-50 mb-6"
        >
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs text-gray-400">
            <span className="bg-white px-3">sau cu email</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="text" required value={form.prenume}
                ...
                className="w-full border rounded-xl px-4 py-3 text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-green-500"
                placeholder="Ion" />
            </div>
            <div>
